...
#. Запустить::
   ...
   .. note:: Для ускорения процесса можно повысить скорость обмена данными по UART. Например::
      ...
      Со стороны ПО поддерживаются все стандартные скорости от 300 бод по 4 Мбод. В том числе:
      ...
      В зависисмоти от качества Linux-драйвера переходника USB-UART устройство терминала
